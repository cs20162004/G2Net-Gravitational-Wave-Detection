...
train_data = np.read_csv("/home/bluedot/Downloads/Ali_star_trek/practice/g2net/dt/training_labels.csv")
...
train_data.to_csv("/home/bluedot/Downloads/Ali_star_trek/practice/g2net/dt/split_train.csv")
